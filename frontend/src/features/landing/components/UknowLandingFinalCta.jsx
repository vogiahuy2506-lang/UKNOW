...
export function UknowLandingFinalCta({ finalCta }) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-uknow-teal to-[#073f4a] px-[6%] py-20 text-center text-white sm:px-[8%] sm:py-[80px]">
      <div
      ...
      <div className="relative z-[1] mt-9 flex flex-wrap justify-center gap-3.5">
        <a
          href="#dang-ky"
          className="inline-block rounded-lg bg-white px-8 py-3.5 text-[0.95rem] font-bold text-uknow-teal shadow transition hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(0,0,0,0.25)]"
        >
          {finalCta.button}
        </a>
        <a
