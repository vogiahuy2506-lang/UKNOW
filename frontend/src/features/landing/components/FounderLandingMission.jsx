 ...
 */
export function FounderLandingMission({ mission }) {
  return (
    <section className="relative overflow-hidden bg-founder-ink px-[6%] py-20 text-[#f5f3ef] sm:px-[8%]">
      <div
        className="pointer-events-none absolute -right-20 top-0 h-72 w-72 rounded-full bg-[#0d6e6e]/20 blur-3xl"
        aria-hidden
      />
      <p className="relative mb-2 text-[0.72rem] font-bold uppercase tracking-widest text-founder-gold">{mission.eyebrow}</p>
