 ...
 */
export function FounderLandingTestimonials({ testimonials, items }) {
  ...
  return (
    <section className="relative bg-founder-paper px-[6%] py-24 sm:px-[8%] sm:py-[100px]">
      <p className="mb-3 text-[0.68rem] font-bold uppercase tracking-[2px] text-founder-teal">{testimonials.eyebrow}</p>
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <h2 className="font-landing max-w-3xl text-[clamp(1.8rem,3vw,2.8rem)] font-black leading-tight tracking-[-0.5px] text-founder-ink">
          {testimonials.title}
        </h2>
        <div className="flex shrink-0 gap-2">
          <button
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full border border-founder-border bg-white text-founder-ink shadow-sm transition hover:bg-founder-cream"
        ...
        {(items || []).map((t) => {
          ...
          return (
            <figure
              ...
              className="relative flex w-[min(100%,340px)] shrink-0 snap-start flex-col rounded-[14px] border border-founder-border bg-white p-7 shadow-sm transition hover:shadow-[0_12px_36px_rgba(0,0,0,0.08)] sm:w-[300px] md:w-[320px]"
            >
              ...
              <figcaption className="mb-4 flex shrink-0 items-center gap-3">
                ...
                <div className="min-w-0 flex-1 text-left">
                  <div className="text-[0.86rem] font-bold text-founder-ink">{t.name}</div>
                  <div className="text-[0.72rem] text-founder-muted">{t.role}</div>
                </div>
              </figcaption>

              <div className="relative z-[1]">
                <span className="pointer-events-none absolute left-0 top-0 font-landing text-[4rem] leading-[0.8] text-founder-teal/12">
                  &ldquo;
                </span>
                <div className="mb-2.5 pt-5 text-[0.8rem] text-founder-gold" aria-hidden>
              ...
              {t.imageUrl ? (
                <div className="relative z-[1] mt-4">
                  <button
                    ...
                    className="group relative w-full overflow-hidden rounded-lg border border-founder-border/80 bg-founder-cream/40 text-left shadow-sm transition hover:border-founder-teal/40 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-founder-teal/50"
                  >
                    <img
                      src={t.imageUrl}
                      alt={proofAlt}
