      ...
      >
        ...
        <div>
          ...
          <select
            ...
            className={`w-full appearance-none rounded-lg border-[1.5px] px-3.5 py-2.5 text-[0.875rem] text-founder-ink outline-none transition focus:shadow-[0_0_0_3px_rgba(11,85,99,0.1)] ${fieldSurface}`}
          >
            <option value="">{formCopy.selectOccupation}</option>
            {founder_OCCUPATION_OPTIONS.map((opt) => (
        ...
        <div>
          ...
          >
            ...
            {founder_INTEREST_OPTIONS.map((opt) => (
              <option key={opt.value} value={opt.value}>
                {getOptionLabel(opt, locale)}
              </option>
            ))}
