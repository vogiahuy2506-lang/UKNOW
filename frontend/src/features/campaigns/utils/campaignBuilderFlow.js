...
const COMMON_DATA_NODE_TYPES = ['read_sheet', 'read_courses_db', 'read_interested_customers', 'save_customer'];
...
const ZALO_GROUP_COMMON_DATA_NODE_TYPES = ['read_sheet', 'read_courses_db', 'save_customer'];
