...
const ROUTE_FEATURE_MAP = [
  ...
  { test: (p) => p.includes('/settings/templates'), key: HELP_FEATURE_KEYS.CAMPAIGN_CREATE },
  { test: (p) => p.includes('/delivery-monitor'), key: HELP_FEATURE_KEYS.CAMPAIGN_CREATE },
  { test: (p) => p.includes('/customers'), key: HELP_FEATURE_KEYS.CUSTOMERS },
  { test: (p) => p.includes('/chatbot-studio'), key: HELP_FEATURE_KEYS.CHATBOT },
  { test: (p) => p.includes('/settings/inbox'), key: HELP_FEATURE_KEYS.INBOX },
  { test: (p) => p.includes('/settings/media-library'), key: HELP_FEATURE_KEYS.INBOX },
  { test: (p) => p.includes('/settings/landing-pages') || p.includes('/landing-leads'), key: HELP_FEATURE_KEYS.LANDING_PAGE },
  { test: (p) => p.includes('/settings/employees'), key: HELP_FEATURE_KEYS.EMPLOYEES },
