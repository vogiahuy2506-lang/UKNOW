...
const userMenuItems = [
  ...
  },
  {
    ...
    ownerOnly: true,
    children: [
      { name: 'Quản lý Email', path: '/app/settings/email', icon: HiOutlineMail, ownerOnly: true },
      { name: 'Mẫu Email', path: '/app/settings/email-templates', icon: HiOutlineTemplate, permission: ['email_templates'] },
      { name: 'Quản lý Zalo', path: '/app/settings/zalo', icon: HiOutlineChat, ownerOnly: true },
      { name: 'Mẫu Zalo', path: '/app/settings/zalo-templates', icon: HiOutlineTemplate, permission: ['zalo_templates'] },
