        ...
        <div className="grid md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-md mb-6">
              Founder AI là giải pháp Marketing Automation & AI hàng đầu cho doanh nghiệp Việt Nam. Giúp tự động hóa chăm sóc khách hàng và tăng doanh thu hiệu quả.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold mb-4 text-white">Văn phòng</h4>
            ...
            <li className="flex items-start gap-2">
                ...
                <span>Phòng I101B, Khu Công nghệ phần mềm ĐHQG - HCM, Đường Võ Trường Toản, Khu phố 6, Phường Linh Xuân, Thành phố Hồ Chí Minh, Việt Nam</span>
              </li>
               </ul>
          </div>
