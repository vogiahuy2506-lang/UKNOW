...
• nodeType: "action", nodeSubtype: "send_email"
  config bắt buộc:
    ...
    "templateMappings": [{ "key": "full_name", "sourceType": "node", "nodeId": "<tempId_node_interested_customers>", "field": "full_name" }],
