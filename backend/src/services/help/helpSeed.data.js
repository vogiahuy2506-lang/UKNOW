...
- [Khách hàng](khach-hang)`,
  ...
  },
  {
    ...
    summary: 'Thêm người vào team: người mới có sẵn hai quyền chỉ xem, phần còn lại bạn tự cấp. Kèm cách nhân viên chuyển sang không gian công ty và cách xử lý khi nhân viên không thấy chiến dịch của công ty.',
    body_md: `# Nhân viên & phân quyền
Thêm người trong team vào cùng làm trong không gian của bạn, mỗi người chỉ thấy phần việc bạn cho phép. Người vừa được thêm có sẵn **hai quyền chỉ xem**: xem chiến dịch và mở trang Tổng quan — nên họ vào là thấy việc của công ty ngay. Những phần còn lại (sửa, gửi, khách hàng, Trợ lý AI…) bạn tự tick trong màn **Phân quyền**.
