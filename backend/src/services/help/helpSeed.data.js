...
1. Kéo khối **Khởi chạy** từ bảng bên phải thả vào khu vực trống làm điểm bắt đầu.

   [ẢNH: kéo khối Khởi chạy từ bảng bên phải thả vào khu vực dựng]
...
Trong thời gian chờ, bạn vẫn dùng đầy đủ quyền lợi của gói cũ. Ở **Gói & Thanh toán → Tổng quan gói** sẽ hiện thêm dòng cho biết đang có lệnh hẹn đổi gói và ngày nó có hiệu lực.

[ẢNH: trang Tổng quan gói, khoanh đỏ dòng thông báo lệnh hẹn đổi gói kèm ngày hiệu lực]
