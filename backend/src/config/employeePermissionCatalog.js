...
export const PERMISSION_CATALOG = {
  ...
  reports_view: {
    ...
    labelKey: 'permissions.reports_view',
  ...
  ai_assistant_use: {
    ...
    labelKey: 'permissions.ai_assistant_use',
    descriptionKey: 'permissions.description.ai_assistant_use',
    dependencies: [],
    riskLevel: 'medium',
    defaultForNewEmployee: false,
  },
  marketplace_manage: {
    key: 'marketplace_manage',
    group: PERMISSION_GROUPS.MARKETPLACE,
    labelKey: 'permissions.marketplace_manage',
    descriptionKey: 'permissions.description.marketplace_manage',
    dependencies: [],
    riskLevel: 'medium',
    defaultForNewEmployee: false,
  },
  marketplace_purchase: {
    ...
    group: PERMISSION_GROUPS.MARKETPLACE,
    labelKey: 'permissions.marketplace_purchase',
    descriptionKey: 'permissions.description.marketplace_purchase',
    dependencies: [],
    riskLevel: 'high',
    defaultForNewEmployee: false,
  },
  integrations_manage: {
    ...
    group: PERMISSION_GROUPS.INTEGRATIONS,
    labelKey: 'permissions.integrations_manage',
    descriptionKey: 'permissions.description.integrations_manage',
    dependencies: [],
    riskLevel: 'medium',
    defaultForNewEmployee: false,
  },
