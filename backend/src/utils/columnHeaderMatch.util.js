 ...
 *
 * Dùng chung cho:
 * - Backend: trích xuất danh sách người nhận từ Excel/CSV (`recipientExtractor.service.js`)
 * - Frontend: bộ chạy node CampaignBuilder (`columnHeaderMatch.js` / `campaignBuilderRuntime.js`)
 */
