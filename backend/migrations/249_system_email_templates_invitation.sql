-- Migration 249: Cho phép Super Admin tùy chỉnh mẫu email mời nhân viên tham gia (employee_invitation)
...
ALTER TABLE system_email_templates
  ...
  ADD CONSTRAINT system_email_templates_key_check
    CHECK (template_key IN ('welcome', 'plan_expiring', 'plan_expired', 'employee_invitation'));
